				...
				<Box pt={{ xs: 2, md: 4 }}>
					<Typography variant="body1">
						<PrivacyPolicyViewContent>
							...
							<strong> Vaastraveda Enterprises LLP</strong> and the terms "You" /"Your" / "Yourself"
							refer to the users.
						</PrivacyPolicyViewContent>
						<PrivacyPolicyViewContent>
							...
							statutes as amended by the information Technology Act, 2000. This Privacy Policy does
							not require any physical, electronic or digital signature.
						</PrivacyPolicyViewContent>
						<PrivacyPolicyViewContent>
							This Privacy Policy is a legally binding document between you and Vaastraveda
							Enterprises LLP (both terms defined below). The terms of this Privacy Policy will be
							...
							govern the relationship between you and Vaastraveda Enterprises LLP for your use of
							the website “sertnation.com” (defined below).
						</PrivacyPolicyViewContent>
						<PrivacyPolicyViewContent>
						...
						<PrivacyPolicyViewHead title="user information" />
						<PrivacyPolicyViewContent>
							To avail certain services on our Websites, users are required to provide certain
							information for the registration process namely: - a) your name, b) email address, c)
							sex, d) age, e) PIN code, f) credit card or debit card details g) sexual orientation,
							, h) password etc., and / or your occupation, interests, and the like. The Information
							as supplied by the users enables us to improve our sites and provide you the most
						...
						<PrivacyPolicyViewHead title="cookies" />
						<PrivacyPolicyViewContent>
						...
						<PrivacyPolicyViewHead title="links to other sites" />
						<PrivacyPolicyViewContent>
							Our policy discloses the privacy practices for our own web site only. Our site
							provides links to other websites also that are beyond our control. We shall in no way
							be responsible in way for your use of such sites.
						</PrivacyPolicyViewContent>
						<PrivacyPolicyViewHead title="information sharing" />
						<PrivacyPolicyViewContent>
						...
						<PrivacyPolicyViewContent>
							...
							authority to disclose, for the purpose of verification of identity, or for the
							prevention, detection, investigation including cyber incidents, or for prosecution and
							punishment of offences. These disclosures are made in good faith and belief that such
							disclosure is reasonably necessary for enforcing these Terms; for complying with the
							applicable laws and regulations. 
						</PrivacyPolicyViewContent>{" "}
						<PrivacyPolicyViewContent>
							(b) We proposes to share such information within its group companies and officers and
							employees of such group companies for the purpose of processing personal information
						...
						<PrivacyPolicyViewHead title="information security" />
						<PrivacyPolicyViewContent>
						...
						<PrivacyPolicyViewContent>
							However the internet is an ever evolving medium. We may change our Privacy Policy from
						...
						<PrivacyPolicyViewHead title="grievance redressal" />
						<PrivacyPolicyViewContent>
							...
							electronic signature to Mr. Krishna Negi ("Grievance Officer") 
						</PrivacyPolicyViewContent>
						<PrivacyPolicyViewContent>
							Mr. Krishna Negi (Grievance Officer)
							<br />
							www.sertnation.com
							<br />
							Vaastraveda Enterprises LLP
							<br />
							M-82, Ground Floor, Laxmi Nagar, Delhi-92, India
							<br />
							Email: info@sertnation.com
							<br />
							Ph: 817869005 
							<br />
						</PrivacyPolicyViewContent>
...
const PrivacyPolicyViewHead = ({ title }) => {
	return (
		<>
			<br />
...
const PrivacyPolicyViewContent = ({ children }) => {
	return (
		<>
			{children}
			<br />
